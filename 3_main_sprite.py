...
#캐릭터 (스프라이트) 불러오기
character = pygame.image.load("C:/Users/ilheu/Desktop/pythonworkplace/pygame_basic/character.png")
character_size =  character.get_rect().size # 이미지의 크기를 구해옴
character_width = character_size[0] #캐릭터 가로크기
character_heidht = character_size[1] #캐릭터 세로크기
character_x_pos = (screen_width / 2) - (character_width / 2) # 화면 중앙
character_y_pos = Screen_height - character_heidht # 화면 의 가장 아래
