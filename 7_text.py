...
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) # 화면 중앙
enemy_y_pos = (screen_height / 2) - (enemy_height / 2) # 화면 중앙

# 폰트 정의
game_font = pygame.font.Font(None, 40) # 폰트 객체 생성 (폰트, 크기)

# 타임아웃 정의 (내가 임의로 만들어봄)
# time_out_font = pygame.font.Font(None, 80)
# time_out  = time_out_font.render("Time Out", True, (255,255,255))
...
while running:
    dt = clock.tick(60) # 게임화면 의 초당 프레임수
